const QUIZ_DATA = {
  ...
  questions: [
    ...
    // === READING (Multiple Choice with passage) ===
    {
      ...
      text: "Questions 1-3: Choose the best answer for each sub-question.",
      subQuestions: [
        {
          text: "1. According to the first stage of construction, what tools were likely used to dig the ditch?",
          options: ["Deer antlers", "Timber posts", "Rafts", "Oxen"],
          answer: 0
        },
        {
          text: "2. Where did the bluestones originate from?",
          options: ["Salisbury Plain", "Preseli Hills", "River Avon", "London"],
          answer: 1
        },
        {
          text: "3. What did John Aubrey claim about Stonehenge in the 17th century?",
          options: ["It was built by Celts", "It was the work of druids", "It was a place of healing", "It was a form of calendar"],
          answer: 1
        }
      ],
      points: 15
